...
export default function Lab5() {
  ...
  // Lab 5 specific active regions and their definitions
    ...
    <div className="app-container">
                    ...
                    <div className="content-section">
                      ...
                      <div style={{ color: '#ffffff', lineHeight: '1.8', fontSize: '16px' }}>
                        ...
                        <p style={{ fontSize: '18px', fontWeight: '600', color: '#06ffa5' }}>
                          Handling conflicts with emotional maturity
                        </p>
                        
                        <p>
                          Welcome to Lab 5, where you'll master the art of handling conflicts with wisdom 
                        ...
                        <p>
                          Through scientifically-designed exercises, you'll strengthen your ability to 
                          ...
                          and maintain relationships even in disagreement.
                        </p>
      ...
      <footer className="footer">
        ...
        <div style={{ 
          ...
          Emotional Intelligence • Conflict Resolution • Personal Growth
        </div>
      </footer>
    </div>
  )
